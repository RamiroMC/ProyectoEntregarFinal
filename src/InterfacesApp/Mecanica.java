            ...
            for (Inventario producto : productos) {
                ...
                if (id.equals(idAux)) {
                    ...
                    if (producto.getCantidad() > 0) {
                        ...
                        stock = producto.getCantidad() - 1;

                        //Actualizar el stock en el inventario.
                        producto.setCantidad(stock);
                        InventarioCRUD.Update(producto);
                    } else {
                        //Mostrar mensaje si no hay stock disponible.
                        JOptionPane.showMessageDialog(null, "No hay stock disponible para el material con ID " + idAux, "Alerta", JOptionPane.WARNING_MESSAGE);
                        materialTXT.setText("");
                    }
                }
