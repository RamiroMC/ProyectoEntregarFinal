...
public class TablaClientes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tablaCLIENTES.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Identificacion", "Tipo Vehiculo", "Placa", "Total Deuda"
            }
        ) {
    ...
    private void mostrarBTNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mostrarBTNMouseClicked
        ...
        for (Cliente fila : datos) {
            ...
            ArrayList<Vehiculo> vehiculos = fila.getVehiculos();
                String tipoVehiculo = "";
                String placa = "";

                if (!vehiculos.isEmpty()) {
                    //Teniendo en cuenta que un cliente tiene solo un vehículo.
                    Vehiculo vehiculo = vehiculos.get(0); 
                    tipoVehiculo = vehiculo.getTipoVehiculo();
                    placa = vehiculo.getPlaca();
                }
    
          model.addRow(new Object[]{fila.getNombre(), fila.getId(), tipoVehiculo,placa,deuda_total});
        }
        //Setteamos la tabla.
